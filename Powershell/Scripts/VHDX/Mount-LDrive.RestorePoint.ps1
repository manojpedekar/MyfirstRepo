<#	
	...
	===========================================================================
	 ...
	 Created by:   	DT234083
	 Organization: 	SS&C
	 Filename:     	Mount-LDrive.ps1
	===========================================================================
	.DESCRIPTION
		This script is designed to mount a VHDX file as the L:\ for Developers 
#>
            ...
            If (!(Get-IsAdministrator)) {
                If (Get-IsUacEnabled) {
                    ...
                    ForEach ($boundParam In $PSBoundParameters.GetEnumerator()) {
                        ...
                        Log-Message -message "    $($boundParam.Key)"
                    }
                    
                    Log-Message -message "    $($myInvocation.MyCommand.Definition)"
                    ...
                    Log-Message -message "Starting Admin process"
